...
<aside>
Notice how we didn't use <b>let</b> in our assignment statements the second time? The <i>let</i> keyword is used to declare a variable. If that variable has already been declared, you can just re-assign the variable to another value. Try declaring a variable twice.
</aside>
...
<aside>
Notice the use of parentheses <i>( )</i> to group part of the expression?
</aside>
...
<aside>
Note the use of <b>===</b>. <b>==</b> is used as a comparison operator it coerces the values compared to be comparable. The practical result is that a value like <b>undefined</b> will be coerced to be <b>0</b>.
</aside>

<aside>
If you ever forget to give an argument to a function, the parameter will be <b>undefined</b>. so calling <b>isZero()</b> like so, without an argument will result in the comparison <b>undefined === 0</b>, which is <b>false</b>. If we had used <b>==</b>, the result would have been <b>true</b>. Just something to keep in mind.
</aside>
